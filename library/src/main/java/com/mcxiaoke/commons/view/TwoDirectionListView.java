package com.mcxiaoke.commons.view;
...
public class TwoDirectionListView extends AdapterView<ListAdapter> implements
    ...
    public interface OnScrollListener {
         ...
         */
        public void onScrollStateChanged(TwoDirectionListView view, int scrollState);
         ...
         */
        public void onScroll(TwoDirectionListView view, int firstVisibleItem, int visibleItemCount,
                             int totalItemCount);
    }
     ...
     *
     * @see TwoDirectionListView.RecycleBin
     * @see TwoDirectionListView#setRecyclerListener(TwoDirectionListView.RecyclerListener)
     */
    ...
    public TwoDirectionListView(Context context) {
        this(context, null);
    }

    public TwoDirectionListView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TwoDirectionListView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.TwoDirectionListView, defStyle, 0);
        initializeScrollbars(a);

        mDrawSelectorOnTop = a.getBoolean(
                R.styleable.TwoDirectionListView_android_drawSelectorOnTop, false);

        Drawable d = a.getDrawable(R.styleable.TwoDirectionListView_android_listSelector);
        if (d != null) {
            setSelector(d);
        }

        int orientation = a.getInt(R.styleable.TwoDirectionListView_android_orientation, -1);
        if (orientation >= 0) {
            setOrientation(Orientation.values()[orientation]);
        }

        int choiceMode = a.getInt(R.styleable.TwoDirectionListView_android_choiceMode, -1);
        if (choiceMode >= 0) {
     ...
     *                 in the recycler.
     * @see TwoDirectionListView.RecycleBin
     * @see TwoDirectionListView.RecyclerListener
     */
    ...
    public boolean showContextMenuForChild(View originalView) {
        ...
        if (longPressPosition >= 0) {
            ...
            if (listener != null) {
                handled = listener.onItemLongClick(TwoDirectionListView.this, originalView,
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(TwoDirectionListView.class.getName());
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        info.setClassName(TwoDirectionListView.class.getName());
    ...
    private boolean performLongPress(final View child,
        ...
        OnItemLongClickListener listener = getOnItemLongClickListener();
        if (listener != null) {
            handled = listener.onItemLongClick(TwoDirectionListView.this, child,
                    longPressPosition, longPressId);
        }

        if (!handled) {
            mContextMenuInfo = createContextMenuInfo(child, longPressPosition, longPressId);
            handled = super.showContextMenuForChild(TwoDirectionListView.this);
        }
    ...
    private class AdapterDataSetObserver extends DataSetObserver {
        ...
        public void onChanged() {
            ...
            if (TwoDirectionListView.this.mHasStableIds && mInstanceState != null
                    && mOldItemCount == 0 && mItemCount > 0) {
                TwoDirectionListView.this.onRestoreInstanceState(mInstanceState);
                mInstanceState = null;
            } else {
                rememberSyncState();
            }
        ...
        public void onInvalidated() {
            ...
            if (TwoDirectionListView.this.mHasStableIds) {
                // Remember the current state for the case where our hosting activity is being
                // stopped and later restarted
                mInstanceState = TwoDirectionListView.this.onSaveInstanceState();
            }
    ...
    static class SavedState extends BaseSavedState {
        ...
        /**
         * Constructor called from {@link TwoDirectionListView#onSaveInstanceState()}
         */
    ...
    private static class ArrowScrollFocusResult {
        ...
        /**
         * How {@link TwoDirectionListView#arrowScrollFocused} returns its values.
         */
