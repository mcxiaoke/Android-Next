...
最新版本: [![Maven Central](http://img.shields.io/badge/2020.09.15-com.mcxiaoke.next:core:1.7.0-brightgreen.svg)](http://search.maven.org/#search%7Cga%7C1%7Cg%3A%22com.mcxiaoke.next%22)

## Gradle集成

```groovy
    // core 核心库, 格式:jar和aar
    compile 'com.mcxiaoke.next:core:1.7.0'
    // task 异步任务库，格式:jar和aar
    compile 'com.mcxiaoke.next:task:1.7.0'
    // http HTTP组件, 格式:jar和aar
    compile 'com.mcxiaoke.next:http:1.7.0'
    // 函数操作组件
    compile 'com.mcxiaoke.next:functions:1.7.0'
    // ui UI组件, 格式:aar
    compile 'com.mcxiaoke.next:ui:1.7.0'
    // recycler EndlessRecyclerView, 格式:aar
    compile 'com.mcxiaoke.next:recycler:1.7.0'
    // extra-abc 依赖support-v7 AppCompat 格式:aar
    compile 'com.mcxiaoke.next:extras-abc:1.7.0'
