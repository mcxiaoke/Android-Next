...
// from android\source\packages\apps\Calendar\src\com\android\calendar
public class ExpandableTextView extends LinearLayout implements OnClickListener {
    ...
    void init() {
        // mMaxCollapsedLines =
        // getResources().getInteger((R.integer.event_info_desc_line_num));
        // mExpandDrawable =
        // getResources().getDrawable(R.drawable.ic_expand_small_holo_light);
        // mCollapseDrawable =
        // getResources().getDrawable(R.drawable.ic_collapse_small_holo_light);
        // TODO
        mMaxCollapsedLines = 8;
