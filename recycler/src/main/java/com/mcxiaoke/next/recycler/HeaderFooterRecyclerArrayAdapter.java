...
public abstract class HeaderFooterRecyclerArrayAdapter<T>
    ...
    public HeaderFooterRecyclerArrayAdapter(final Context context) {
        super(context);
    }

    public HeaderFooterRecyclerArrayAdapter(final Context context, final List<T> objects) {
        super(context, objects);
    }

    public HeaderFooterRecyclerArrayAdapter(final Context context, final T[] objects) {
        super(context, objects);
    }
