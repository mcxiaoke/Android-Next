...
public class ByteArrayBody extends AbstractContentBody {
     ...
     *
     * @deprecated (4.3) use {@link com.mcxiaoke.commons.http.entity.mime.content.ByteArrayBody#ByteArrayBody(byte[], com.mcxiaoke.commons.http.entity.ContentType, String)}
