...
package com.mcxiaoke.commons.http.entity.mime;

import com.mcxiaoke.commons.http.entity.ContentType;
import com.mcxiaoke.commons.http.entity.mime.content.ByteArrayBody;
import com.mcxiaoke.commons.http.entity.mime.content.ContentBody;
import com.mcxiaoke.commons.http.entity.mime.content.FileBody;
import com.mcxiaoke.commons.http.entity.mime.content.InputStreamBody;
import com.mcxiaoke.commons.http.entity.mime.content.StringBody;
...
/**
 * Builder for multipart {@link org.apache.http.HttpEntity}s.
 *
 * @since 4.3
 */
public class MultipartEntityBuilder {
    ...
    public MultipartEntityBuilder addPart(final String name, final ContentBody contentBody) {
        ...
        AssertUtils.notNull(contentBody, "Content body");
