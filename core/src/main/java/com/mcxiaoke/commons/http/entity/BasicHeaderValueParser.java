 ...
 * @since 4.0
 */
class BasicHeaderValueParser implements HeaderValueParser {
     ...
     */
    public static HeaderElement[] parseElements(final String value,
     ...
     */
    public static HeaderElement parseHeaderElement(final String value,
                                                   final HeaderValueParser parser) throws ParseException {
        AssertUtils.notNull(value, "Value");
     ...
     */
    public static NameValuePair[] parseParameters(final String value,
                                                  final HeaderValueParser parser) throws ParseException {
        AssertUtils.notNull(value, "Value");
