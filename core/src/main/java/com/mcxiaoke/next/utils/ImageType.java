...
/*	public static final int COLOR_TYPE_UNKNOWN = -1;
    ...
    public static void main(String[] args) {
        ImageType imageInfo = new ImageType();
    ...
    private static void print(String sourceName, ImageType ii, boolean verbose) {
        if (verbose) {
    ...
    private static void printCompact(String sourceName, ImageType imageInfo) {
        final String SEP = "\t";
        System.out.println(
                sourceName + SEP +
    ...
    private static void printVerbose(String sourceName, ImageType ii) {
    ...
    private static void run(String sourceName, InputStream in, ImageType imageInfo, boolean verbose) {
