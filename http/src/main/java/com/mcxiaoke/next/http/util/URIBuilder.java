...
public class URIBuilder {
    ...
    private List<NameValuePair> parseQuery(final String query, final Charset charset) {
        if (query != null && query.length() > 0) {
            return URLUtils.parse(query, charset);
        }
        return null;
    }
    ...
    private String encodeUserInfo(final String userInfo) {
        return URLUtils.encUserInfo(userInfo, Charsets.UTF_8);
    }

    private String encodePath(final String path) {
        return URLUtils.encPath(path, Charsets.UTF_8);
    }

    private String encodeUrlForm(final List<NameValuePair> params) {
        return URLUtils.format(params, Charsets.UTF_8);
    }

    private String encodeUric(final String fragment) {
        return URLUtils.encUric(fragment, Charsets.UTF_8);
    }
     ...
     *
     * @see org.apache.http.client.utils.URLEncodedUtils#parse
     * @deprecated (4.3) use {@link #setParameters(java.util.List)} or {@link #setParameters(org.apache.http.NameValuePair...)}
     */
    @Deprecated
    public URIBuilder setQuery(final String query) {
        this.queryParams = parseQuery(query, Charsets.UTF_8);
        this.query = null;
        this.encodedQuery = null;
        this.encodedSchemeSpecificPart = null;
        return this;
     ...
     * @since 4.3
     */
    public URIBuilder addParameters(final Collection<NameValuePair> nvps) {
        if (this.queryParams == null) {
            this.queryParams = new ArrayList<NameValuePair>();
        }
        this.queryParams.addAll(nvps);
